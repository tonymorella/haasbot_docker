...
#RUN find /etc/apt/*.list -type f -print0 | xargs -0 sed 's/archive.ubuntu/kr.archive.ubuntu/'
...
#ENTRYPOINT  mono-service HTS.exe
...
#RUN chown -R haasbot:haasbot /haasonline/*
